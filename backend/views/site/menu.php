        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
		      ...
		      <li class="nav-item">
            <a href="http://shop/backend/index.php?model=permission&action=read" class="nav-link">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Permissions
                <i class="fas fa-angle-left right"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="http://shop/backend/index.php?model=permission&action=create" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
		  ...
		  <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="http://shop/backend/index.php?model=delivery&action=create" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create Delivery</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="http://shop/backend/index.php?model=delivery&action=read" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Delivery</p>
                </a>
              </li>
		  ...
		  <li class="nav-item">
            <a href="http://shop/backend/model=access&action=update" class="nav-link">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Access
                <i class="fas fa-angle-left right"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="http://shop/backend/index.php?model=access&action=update" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Access</p>
                </a>
              </li>
